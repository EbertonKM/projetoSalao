...
@Controller
public class TelaProfissionalController {
    ...
    public TelaProfissionalController(TelaInicial telaInicial, TelaAgendamentos telaAgendamentos, TelaAgendarAtendimento telaAgendarAtendimento) {
